...
export default function QuestionsSettings() {
  ...
  return (
    <View style={style.selectArea}>
      <GluestackUIProvider config={config}>
        <Text style={{ fontSize: 40, color: "black" }}>{informationText}</Text>

        {screenNumber === 0 ? (
          <>
            <Slider
              style={{ width: 200, height: 40, padding: 60 }}
              ...
              step={5}
            />
            <Text>Value: {numberOfQuestion}</Text>
          </>
        ) : screenNumber === 1 ? (
          <>
            <Button
                ...
                <ScrollView>
                  <SelectContent>
                    ...
                    <SelectItem
                      ...
                      value="13"
                    />
                    <SelectItem label="Entertainment: Television" value="14" />
                    <SelectItem label="Entertainment: Video Games" value="15" />
                    <SelectItem label="Entertainment: Board Games" value="16" />
